...
INSERT INTO Planes (Id, [Name], Seats, [Range])
VALUES (1, 'Browsedrive', 231, 3486),
...
INSERT INTO Flights (Id, DepartureTime, ArrivalTime, Origin, Destination, PlaneId)
VALUES (1, '2019-04-27 18:20:45', '2019-08-17 09:21:49', 'Kolyshley', 'Rancabolang', 13),
...
INSERT INTO Passengers (Id, FirstName, LastName, Age, Address, PassportId)
VALUES (1, 'Marylinda', 'Landrieu', 69, '3 Bobwhite Junction', '847-03-2587'),
...
INSERT INTO LuggageTypes (Id, Type)
VALUES (1, 'Carry-On'),
       (2, 'Upright Luggage'),
...
INSERT INTO Luggages (Id, LuggageTypeId, PassengerId)
VALUES (1, 4, 89),
       (2, 7, 78),
       (3, 1, 35),
       (4, 5, 51),
...
INSERT INTO Tickets(Id, PassengerId, FlightId, LuggageId, Price)
VALUES (1, 69, 17, 3, 247.14),
       (2, 87, 12, 47, 447.82),
       (3, 91, 48, 59, 404.87),
       (4, 18, 76, 69, 276.14),
       (5, 33, 39, 82, 274.46),
